...
public interface PhpParserTokenTypes {
	...
	int NUMBER = 150;
	int PARAMETERS = 151;
	int PARAMETER_DEF = 152;
	int ELIST = 153;
	int EXPR = 154;
	int FUNCTION_DEF = 155;
	int FUNCTION_BODY = 156;
	int FOR_INIT = 157;
	int FOR_CONDITION = 158;
	int FOR_ITERATOR = 159;
	int COLON_SLIST = 160;
	int LABEL = 161;
	int TYPE_CAST = 162;
	int CLASS_BODY = 163;
	...
	int FUNC_CALL = 166;
	int TYPE = 167;
	int VARIABLE_DEF = 168;
	int CASE_GROUP = 169;
	int SLIST = 170;
	int POST_INC = 171;
	int POST_DEC = 172;
	int ARRAY_DECLARATOR = 173;
	int ARRAY_INIT = 174;
	int ARRAY_ELEM = 175;
	int ARRAY_INDEX = 176;
	int UNARY_PLUS = 177;
